...
if(trim($subject) == '') {
	echo '<div class="error_message"><i class="fa fa-close"></i> Please enter a subject.</div>';
	exit();
} else if(trim($msg) == '') {
	echo '<div class="error_message"><i class="fa fa-close"></i> Please enter your message.</div>';
	exit();
} 
