...
function footer_text() {
    echo "<p style='font-size:12px;text-align:right'>Themes By <a href=\"http://bootstrapthemes.co/\">Bootstrap Themes</a><br />";
    echo "Powered by <a href=\"http://wordpress.org\">Wordpress</a></p>";
}
add_action('softtech_footer', 'footer_text');